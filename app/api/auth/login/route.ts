...
export async function POST(request: Request) {
  try {
    ...
    const { member, cookie } = await authenticateAlumniMember(typeof payload.loginId === "string" ? payload.loginId : "", typeof payload.password === "string" ? payload.password : "", request);
